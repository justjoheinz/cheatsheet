...
#page-title[Parole Utili][AVVERBI · CONGIUNZIONI · INDEFINITI · LUOGO]
...
#vocab-group("Quantität & Indefinita", (
  ...
  ("troppo/a",  "zu viel / zu"),
  ("qualche",   "einige / ein paar",  "immer + Singular: qualche libro (ein paar Bücher) — nie Plural"),
  ("alcuni/e",  "einige / manche",    "immer + Plural: alcuni libri · alcune ragazze"),
  ("qualcosa",  "etwas"),
